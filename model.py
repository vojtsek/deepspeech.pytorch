...
class DeepSpeech(nn.Module):
    ...
    def serialize(model, optimizer=None, epoch=None, iteration=None, loss_results=None,
                  cer_results=None, wer_results=None, avg_loss=None, meta=None, early_stopping_history=None):
        ...
        if meta is not None:
            package['meta'] = meta
        if early_stopping_history is not None:
            package['early_stopping_history'] = early_stopping_history
        return package
